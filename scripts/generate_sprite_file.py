...
header.write('struct Sprite {Vec2i size; const char* name; const uint8_t* data; };\n\n')
...
for infile_name in glob('./img/*'):
	...
	arrays.write('};\n')
	sprites.write(f'constexpr Sprite {img_name} = {{Vec2i({width}, {height}), "{img_name}", {img_name}__data}};\n')
